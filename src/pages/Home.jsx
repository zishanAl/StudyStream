  ...
  return (
    <div>
        ...
        <div className='relative mx-auto flex flex-col w-11/12 items-center max-w-maxContent text-white
            ...
            Our online coding courses allow you to learn flexibly, at your own speed, from any location, while gaining access to valuable resources such as practical projects, quizzes, and tailored feedback from experienced instructors. 
            </div>
            ...
            <div>
                <CodeBlocks 
                    ...
                    subheading = {
                        "Our courses, crafted and led by seasoned industry professionals, bring years of coding expertise and a passion for teaching directly to you."
                    }
                    ctabtn1={
                        {
            ...
            <div> 
                <CodeBlocks 
                    ...
                    heading={
                        <div className='text-4xl font-semibold'>
                            Start 
                            <HighlightText text={`Developments`}/>
                            <br />
        ...
        <div className="bg-pure-greys-5 text-richblack-700">
            ...
            <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
                ...
                The modern StudyStream sets its own standards. In today's world, being a competitive professional demands more than just technical expertise.
                </div>
                <CTAButton active={true} linkto={"/signup"}>
